...
const defaultWorkflow: Workflow = {
  ...
  version: 1,
  nodes: [
    { id: 'forecast', type: 'stage', position: { x: 100, y: 100 }, data: { label: 'FORECAST' } },
    { id: 'planning', type: 'stage', position: { x: 300, y: 100 }, data: { label: 'PLANNING' } },
    { id: 'submitted', type: 'stage', position: { x: 500, y: 100 }, data: { label: 'SUBMITTED' } },
    { id: 'submission-review', type: 'stage', position: { x: 700, y: 100 }, data: { label: 'SUBMISSION_REVIEW' } },
    { id: 'device-entry', type: 'stage', position: { x: 900, y: 100 }, data: { label: 'DEVICE_ENTRY' } },
    { id: 'device-testing', type: 'stage', position: { x: 1100, y: 100 }, data: { label: 'DEVICE_TESTING' } },
    { id: 'taq-review', type: 'stage', position: { x: 1300, y: 100 }, data: { label: 'TAQ_REVIEW' } },
    { id: 'ta-complete', type: 'stage', position: { x: 1500, y: 100 }, data: { label: 'TA_COMPLETE' } },
    { id: 'closed', type: 'stage', position: { x: 1700, y: 100 }, data: { label: 'CLOSED' } },
  ],
  edges: [],
